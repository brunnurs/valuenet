...
def process_datas(datas, related_to_concept, is_a_concept):
    ...
    for entry in datas:
        ...
        while idx < num_toks:
            ...
            if nltk_result[idx][1] == 'RBR' or nltk_result[idx][1] == 'JJR':    # with the help of NLTK part of speech we are
                tok_concol.append([question_toks[idx]])                         # looking for comparative words like "better", "bigger"
                type_concol.append(['MORE'])
                idx += 1
                continue

            if nltk_result[idx][1] == 'RBS' or nltk_result[idx][1] == 'JJS':    # with the help of NLTK part of speech we are
                tok_concol.append([question_toks[idx]])                         # looking for superlative words like "best", "biggest"
...
if __name__ == '__main__':
    ...
    with open(args.output, 'w') as f:
        json.dump(datas, f, sort_keys=True, indent=2)
