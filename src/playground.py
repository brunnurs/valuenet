...
columns = [['count', 'number', 'many'], ['college', 'name'], ['state'], ['enrollment'], ['player', 'id'], ['player', 'name'], ['yes', 'card'], ['training', 'hour'], ['player', 'position'], ['decision']]
...
#
encoder = TransformerEncoder('bert-base-uncased', device, 512)
encoder.to(device)

last_layer = encoder([question, question2], [columns, columns], [tables, tables])
print(last_layer)